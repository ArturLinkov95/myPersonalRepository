...
const chatList = document.getElementById("chat-list") as HTMLUListElement | null;
const chatSend = document.getElementById("chat-send") as HTMLFormElement | null;
const templateMe = document.getElementById("template-me") as HTMLTemplateElement | null;
const templateFrom = document.getElementById("template-from") as HTMLTemplateElement | null;
const buttonDown = document.getElementById("button-down");

if (!chatInput || !chatList || !chatSend || !templateMe || !templateFrom || !buttonDown) {
...
function getTimeData(timeData: number | string | Date = Date.now()): string {
...
function renderMessage(userName: string, userMessage: string, timeMessage: string, userEmail = email) {
